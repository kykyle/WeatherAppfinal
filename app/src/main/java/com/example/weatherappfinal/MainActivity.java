...
public class MainActivity extends AppCompatActivity {
    ...
    String Key="06d813f45eacda00565ce7c6d7331777";
    ...
    TextView txtCity,txtTime,txtValueFeelLike,txtValueHumidity,txtTemp;
    ImageView imageView;
    EditText edt;
    Button btn;
    ...
    public void Check(View view){
        ...
        rlRoot.setBackgroundColor(Color.parseColor("#3194E1"));
        ...
        try {
            ...
            txtValueFeelLike.setText(feel_Like + "°C");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtValueFeelLike= findViewById(R.id.textValueFeelLike);
